        ...
        messages: list[dict[str, str]] = [
            {
                ...
                "content": (
                    ...
                    "- If the user asks to update an event, respond with: "
                    "[ACTION:CALENDAR_UPDATE {\"eventId\":\"...\", ...}].\n"
                    "- If the user asks to delete/cancel an event, respond with: "
                    "[ACTION:CALENDAR_DELETE {\"eventId\":\"...\"}].\n"
                    "- When you receive calendar data in [CALENDAR_DATA_READONLY] tags, "
                    "summarize it naturally in the user's language. Never repeat raw data verbatim.\n"
                    "- Do NOT invent calendar events. Only summarize data you actually receive.\n"
