        ...
        messages: list[dict[str, str]] = [
            {
                ...
                "content": (
                    ...
                    "AGENT MODE: For tasks requiring code writing, file operations, "
                    "shell commands, or complex multi-step actions, respond ONLY with "
                    "the tag: [ACTION:AGENT_MODE]\n"
                    "Such tasks include: create/edit files, run terminal commands, "
                    "write scripts, analyze codebases, build or test projects.\n"
                    "For simple questions (answers, summaries, explanations) do NOT use "
                    "this tag — answer directly.\n\n"
